 ...
 *
 */
public class MenuTreeService extends CommonTree {
	
	private static MenuTreeService instance = null;
	
	private MenuTreeService() {}
	
	public static MenuTreeService getInstance() {
		synchronized (MenuTreeService.class) {
			if (null == instance) {
				instance = new MenuTreeService();
			}
		}
		return instance;
	}
