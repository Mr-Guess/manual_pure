...
public class BaseMapperTemplate implements ITemplate
{
  protected static String nl;
  public static synchronized BaseMapperTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    BaseMapperTemplate result = new BaseMapperTemplate();
    nl = null;
    return result;
  }
