...
<body style="margin:0 auto;width:100%;overflow: hidden;text-align: center;">
	<div id="toolbar" style="height: 30px;overflow: hidden;">
		<form id="enterpriseGrid_searchForm" method="post">
				&nbsp;&nbsp;单位组织机构代码:&nbsp;&nbsp;<input type="text" style="width: 150px;"
					name="enterprise.zzjgdm" /> &nbsp;&nbsp;单位名称:&nbsp;&nbsp;<input style="width: 150px;"
	...
	<div>
		<table title="选择企业" style="width:778px;height:388px;" id="dataList">
			<thead>
				<tr>
