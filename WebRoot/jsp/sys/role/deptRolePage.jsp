     ...
     // 提交添加菜单请求
        ...
        $(document).ready(
                function () {
                    ...
                    closeAllWin();
                    grid = new Grid('${ctx}/sysRole/sysRole!pageList.action?sysRole.roleType=2','data_list');
                    grid.loadGrid();
                    tree = new Tree('${ctx}/dept/deptAction!reloadDeptEntTree.action', 'dept_tree', 'tree_search', 'key', doSearch);
                    tree.loadTree();
                    deptUserTree = new Tree('${ctx}/sysGroup/sysGroup!reloadEntUserTree.action', 'dept_user_tree', 'dept_user_tree_search', 'key_user_tree', doSearch);
                    deptUserTree.loadTree();
                    menuOptTree = new MenuTree('${ctx}/menu/menuAction!entTreeLoad.action', '${ctx}/menu/menuAction!getMenuOptByMenuId.action', 'menu_opt_tree', 'menu_opt_tree_search', 'key', doSearch);
...
<body onresize="resizeGrid();">
	...
	<div  id="toolbar">
		<form id="searchForm" method="post" style="display: inline;">
			<input type="hidden" value="2" name="sysRole.roleType" />
			&nbsp;&nbsp;角色名称:&nbsp;&nbsp;<input class="easyui-validatebox"
				id="searchRoleName" name="sysRole.roleName" onkeyup="searchForm();" onblur="searchForm();" /> 
<!-- 				&nbsp;&nbsp;<a -->
<!-- 				href="javascript:void(0)" class="easyui-linkbutton" -->
<!-- 				iconCls="icon-search" onclick="searchForm();">查询</a>  -->
<!-- 				&nbsp;&nbsp;<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-clear" onclick="clearSearchForm();">清空</a> -->
	...
	<div class="search_add">
		...
		&nbsp;&nbsp;<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel', plain:true" onclick="clearSearchForm();">清空</a>
	</div>
	</div>
	<div style="height: 72%">
 ...
 -->
	...
	<div id="deptUserTreeWin" iconCls="icon-save" title="用户授权">
		<div id="p" class="easyui-panel" title="企业树" fit="true" tools="#tt"
			border="false" plain="true">
			<div id="dept_user_tree_search" style="">
				关键字:<input type="text" id="key_user_tree" name="key_user_tree"
					style="width: 80px;" /><a href="#" class="easyui-linkbutton"
					iconCls="icon-search" plain="true"
					onclick="deptUserTree.searchNode();">搜索</a>
			</div>
