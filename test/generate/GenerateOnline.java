 ...
 * @author WangXin
 */
public class GenerateOnline
{
    private static Logger log = LoggerFactory.getLogger(GenerateOnline.class);
            ...
            String generatePackage, String className)
    {
        ...
        for (TemplateType type : types)
        {
            ...
            case SqlMapper:
                fileNameString = GenerateTool
                        .packageToPathDeath(!hasPackage ? generatePackage
                                : generatePackage + ".sqlMapper")
...
//        XmlHandler.alterSSIXml(strutsXmlFile, springXmlFile, sqlMapperXmlFile,
