...
//向上取整
	...
	$(function(){
		$.post('menu/menuAction!initMenu2.action',{checkType:'gov'},function(data){
		//alert(data);
			var data = eval('(' + data + ')');
			var showlist = $('#nav');
			console.log(data);
	...
	//返回到首页
	function backMain(){
		$('#main').attr('src','${ctx}/welcome.jsp?type=1');
		$('#main').show();
		$('#GisMain').hide();
	}
</script>
			    ...
			    (
				    ...
				    "</span>" 
						...
						<td>
							...
							<div id="link_clor">
								<a class="dock-item" href="javascript:backMain();"
	...
	<div style="height: 80%; margin: 0; padding: 0; width: 100%;">
		<div id="iframeTd" style="height: 100%; margin: 0; padding: 0;">
			...
			<iframe id="main" name="main" width="100%" src="welcome.jsp?type=1"
				frameborder="0" onload="mainInit()"></iframe>
