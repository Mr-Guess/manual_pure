...
public class BaseMapperTemplateMysql implements ITemplate
{
  protected static String nl;
  public static synchronized BaseMapperTemplateMysql create(String lineSeparator)
  {
    nl = lineSeparator;
    BaseMapperTemplateMysql result = new BaseMapperTemplateMysql();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_12 = " like CONCAT('%',#";
