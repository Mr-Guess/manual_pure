...
if(!tip&&msg=='&nbsp;该输入项为必输项'){
	tip=$("<div class=\"validatebox-tip\" style=\"margin-left:15px\">"+"<span class=\"validatebox-tip-content\">"+"</span>"+"<span class=\"validatebox-tip-pointer\">"+"</span>"+"</div>").appendTo("body");
	$.data(_38c,"validatebox").tip=tip;
}else if(!tip&&msg!='&nbsp;该输入项为必输项'){
