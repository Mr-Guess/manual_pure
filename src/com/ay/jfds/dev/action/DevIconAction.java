...
import com.ay.jfds.dev.service.DevIconService;
 ...
 * @version 1.0
 */
public class DevIconAction extends BaseAction {
	private DevIconService iconService;//图片管理接口
	...
	public DevIconService getIconService() {
		return iconService;
	}
	public void setIconService(DevIconService iconService) {
	...
	public String delBatch() {
		try{
			...
			List<DevIcon> iconListNew = new Vector();//只保存icon_id  icon_type
